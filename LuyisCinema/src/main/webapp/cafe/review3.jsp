...
<div class="wrapper">
 <div style="display: flex; align-items: center; padding: 150px; padding-bottom: 50px">
  <img src="https://caching.lottecinema.co.kr//Media/MovieFile/MovieImg/202304/19666_103_1.jpg" style="width: 280px;height: 410px; margin-right: 40px; ">
  <div style="margin-left: 200px;">
    <table>
      <tr>
        <th colspan="2" style="font-size: 30px; padding-bottom: 80px;">에어</th>
      </tr>
      <tr>
        <td style="font-weight: bold; font-size: 25px">장르</td>
        <td style="font-size: 20px">  &nbsp&nbsp  드라마</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">개봉일</td>
        <td style="font-size: 20px"> &nbsp&nbsp   2023년 04월 05일</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="font-size: 20px">  &nbsp&nbsp  112분</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">감독</td>
        <td style="font-size: 20px">  &nbsp&nbsp  벤 애플렉</td>
      </tr>
    </table>
  </div>
 </div>
...
src="https://www.youtube.com/embed/Dcpul4ZJPpM" 
