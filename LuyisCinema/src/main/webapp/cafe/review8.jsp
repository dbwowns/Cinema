...
<div class="wrapper">
 <div style="display: flex; align-items: center; padding: 150px; padding-bottom: 50px">
  <img src="https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20230403_204%2F1680507641170NKvOl_JPEG%2Fmovie_image.jpg"  style="width: 280px;height: 410px; margin-right: 40px; ">
  <div style="margin-left: 200px;">
    <table>
      <tr>
        <th colspan="2" style="font-size: 30px; padding-bottom: 80px;">드림</th>
      </tr>
      <tr>
        <td style="font-weight: bold; font-size: 25px">장르</td>
        <td style="font-size: 20px">  &nbsp&nbsp  코미디, 드라마</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="font-size: 20px">  &nbsp&nbsp  125분</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">감독</td>
        <td style="font-size: 20px">  &nbsp&nbsp  이병헌</td>
      </tr>
    </table>
  </div>
 </div>
...
src="https://www.youtube.com/embed/jX0AS9DpOic" 
