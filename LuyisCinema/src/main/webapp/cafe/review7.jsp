...
<div class="wrapper">
 <div style="display: flex; align-items: center; padding: 150px; padding-bottom: 50px">
  <img src="https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20221216_283%2F1671153488789d3g4j_JPEG%2Fmovie_image.jpg"  style="width: 280px;height: 410px; margin-right: 40px; ">
  <div style="margin-left: 200px;">
    <table>
      <tr>
        <th colspan="2" style="font-size: 30px; padding-bottom: 80px;">더 퍼스트 슬램덩크</th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="font-size: 20px"> &nbsp&nbsp   2023년 01월 04일</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="font-size: 20px">  &nbsp&nbsp  124분</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">감독</td>
        <td style="font-size: 20px">  &nbsp&nbsp  이노우에 다케히코</td>
      </tr>
    </table>
  </div>
 </div>
...
src="https://www.youtube.com/embed/SXkhnmdxVYw" 
