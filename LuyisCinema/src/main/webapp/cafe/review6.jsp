...
<div class="wrapper">
 <div style="display: flex; align-items: center; padding: 150px; padding-bottom: 50px">
  <img src="https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20230309_3%2F1678329123596Kpcdb_JPEG%2Fmovie_image.jpg"  style="width: 280px;height: 410px; margin-right: 40px; ">
  <div style="margin-left: 200px;">
    <table>
      <tr>
        <th colspan="2" style="font-size: 30px; padding-bottom: 80px;">슈퍼 마리오 브라더스</th>
      </tr>
      <tr>
        <td style="font-weight: bold; font-size: 25px">장르</td>
        <td style="font-size: 20px">  &nbsp&nbsp  애니메이션, 모험, 코미디</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">개봉일</td>
        <td style="font-size: 20px"> &nbsp&nbsp   2023년 04월 26일</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">등급</td>
        <td style="font-size: 20px">  &nbsp&nbsp  전체 관람가</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">러닝타임</td>
        <td style="font-size: 20px">  &nbsp&nbsp  92분</td>
      </tr>
      <tr>
        <td style="font-weight: bold;font-size: 25px">감독</td>
        <td style="font-size: 20px">  &nbsp&nbsp  아론 호바스, 마이클 제레닉</td>
      </tr>
    </table>
  </div>
 </div>
...
src="https://www.youtube.com/embed/4Oky0NapIB4" 
