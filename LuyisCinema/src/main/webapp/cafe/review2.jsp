...
<div class="wrapper">
 <div style="display: flex; align-items: center; padding: 150px; padding-bottom: 50px">
  <img src="https://caching.lottecinema.co.kr//Media/MovieFile/MovieImg/202304/19606_103_1.jpg" style="width: 280px;height: 410px; margin-right: 40px; ">
  <div style="margin-left: 200px;">
    <table>
      <tr>
        <th colspan="2" style="font-size: 30px; padding-bottom: 80px;">리바운드</th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="font-size: 20px">  &nbsp&nbsp  장항준</td>
      </tr>
    </table>
  </div>
 </div>
...
src="https://www.youtube.com/embed/kpXyRiJLORQ" 
